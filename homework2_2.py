...
class Person:
    def __init__(self, name: str, surname: str, age: int, email: str, university: str):
...
student_1 = Person(name='Karine', surname='Vardanyan', age=20, email='karine.vardanyan444@gmail.com', university='NPUA')
...
student_2 = Student(name='Karine', surname='Vardanyan', age=20, email='karine.vardanyan444@gmail.com',university='NPUA', year=2018)
...
product_1 = Product(product_name='hasbro', type='toy', price=29900, quantity=3)
...
room_1 = Hotel(name="Marriott", place='Sayat Nova Street, Yerevan',
...
taxi_1 = Taxi(car_name='BMW', car_types="Lux", price_for_trip=90000)
...
global_presentation = Tour(name_of_tour='Noravanq tour', price_lux=60000, price_mid=40000, car_name='ride_over',
                           car_types='BMW', price_for_trip=20000, name='Mannam', place="Noravanq",
                           rooms_mid={'Room_1': 'Free', 'Room_2': 'Free', 'Room_3': 'Free'},
                           rooms_lux={'Room_1': 'Free', 'Room_2': 'Free', 'Room_3': 'Free'}, mid_room_price=20000,
                           lux_room_price=30000)
